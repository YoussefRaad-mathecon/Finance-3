...
def priceHestonCallViaMilsteinMC(S0, v0, r, kappa, theta, sigma, rho, lambda_, T, n, N, K):
    ...
    return option_price, std_dev, computing_time, v_zero_count

option_price, std_dev, computing_time, v_zero_count = (priceHestonCallViaMilsteinMC(S0, v0, r, kappa, theta, sigma, rho, lambda_, T, n, N, K))
